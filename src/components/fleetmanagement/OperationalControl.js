            ...
            <div className="col-lg-4 navTitles">
              <div className="nav w-100 nav-pills me-4">
                <button
                  ...
                  type="button"
                >
                  <img className="greenIcon" src="/assets/images/icons/driver.png"/>
                ...
                <button
                  ...
                  type="button"
                >
                  <img className="greenIcon" src="/assets/images/icons/assetTracking.png"/>
                ...
                <button
                  ...
                  type="button"
                >
                  <img className="greenIcon" src="/assets/images/icons/cruise.png"/>
                ...
                <div className="tab-pane fade show active" id="tab-pane-1">
                  <div className="row g-4">
                    ...
                    <div className="col-md-4 transBack">
                      ...
                      <a href="/products/driver-behavior.html" className="btn btn-primary py-3 px-5 mt-3" style={{ color: "white" }}>
                ...
                <div className="tab-pane fade" id="tab-pane-2">
                  <div className="row g-4">
                    ...
                    <div className="col-md-4 transBack">
                      ...
                      <a href="/products/Asset-Tracking.html" className="btn btn-primary py-3 px-5 mt-3" style={{ color: "white" }}>
                        Read More<i className="fa fa-arrow-right ms-3"></i>
                      </a>
                    </div>
                  </div>
                ...
                <div className="tab-pane fade" id="tab-pane-3">
                  <div className="row g-4">
                    ...
                    <div className="col-md-4 transBack">
                      ...
                      <a href="/products/ADAS-and-Camera-Systems.html" className="btn btn-primary py-3 px-5 mt-3" style={{ color: "white" }}>
                        Read More<i className="fa fa-arrow-right ms-3"></i>
                      </a>
                    </div>
                  </div>
