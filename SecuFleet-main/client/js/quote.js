...
function submitFormWeb() {
    if (validateEmail('webdev-email', 'webdevEmailError')) {
        ...
        fetch('https://secuback.onrender.com/api/quotations/web', {
            method: 'POST',
...
function fleetsubmitForm() {
    if (validateEmail('email', 'EmailError')) {
        ...
        fetch('https://secuback.onrender.com/api/fleet', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
...
function submitFormApp() {
    if (validateEmail('appdev-email', 'appdevEmailError')) {
        ...
        console.log(payload)
        fetch('https://secuback.onrender.com/api/quotations/app/create', {
            method: 'POST',
            // mode: 'no-cors',
            headers: {
                'Content-Type': 'application/json',
...
function submitFormConsulting() {
    if (validateEmail('consulting-email', 'consultingEmailError')) {
        ...
        // console.log(platforms);
        console.log(payload)
        fetch('https://secuback.onrender.com/api/consulting/create', {
            method: 'POST',
            // mode: 'no-cors',
            headers: {
                'Content-Type': 'application/json',
