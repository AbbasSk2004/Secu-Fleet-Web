...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (!image || !text || !content) {
        console.log('AboutSlider elements not found on this page. Skipping initialization.');
        return;
    }
    ...
    function changeContent(section) {
        ...
        if (!image || !text) {
            console.error('Image or text element not found. Elements may not be loaded yet.');
            return;
        }
